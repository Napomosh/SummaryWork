...
#include <pdftron/C/PDF/TRN_X501DistinguishedName.h>
...
#include <pdftron/PDF/X501AttributeTypeAndValue.h>
...
public:
	 ...
	 */
	std::vector<pdftron::PDF::X501AttributeTypeAndValue> GetAllAttributesAndValues() const;
...
#include <pdftron/Impl/X501DistinguishedName.inl>
} //end pdftron
} //end PDF
