...
#include <pdftron/C/PDF/TRN_PDFRasterizer.h>
#include <pdftron/C/PDF/TRN_DocumentConversion.h>
#include <pdftron/C/PDF/TRN_ExternalAnnotManager.h>
#include <pdftron/C/PDF/TRN_Page.h>
