...
#include <pdftron/C/PDF/TRN_ObjectIdentifier.h>
...
TRN_API TRN_X501DistinguishedNameGetStringValuesForAttribute(TRN_X501DistinguishedName self, TRN_ObjectIdentifier obj, TRN_Vector* result);
